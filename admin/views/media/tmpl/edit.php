...
if( isset( $_GET['id'] ) ) $action .= '&id=' . $_GET['id'];
...
<div class="wrap yendif-player <?php echo $page; ?>">
  <div class="yendif-player-header">
    <h2 class="yendif-player-left">
      <?php _e( 'Edit Media', YENDIF_PLAYER_PLUGIN_SLUG ); ?>
    </h2>
  ...
  <form enctype="multipart/form-data" method="post" action="<?php echo $action; ?>" class="<?php echo $page; ?>-form" id="yendif-player-form">
    ...
    <div class="yendif-player-left-content">
      <input type="text" name="title" class="required yendif-player-title" placeholder="<?php _e( 'Enter title here', YENDIF_PLAYER_PLUGIN_SLUG ); ?>" value="<?php echo $item->title; ?>" />      
      <div class="yendif-player-box">
        ...
        <table class="yendif-player-form-table">
          <tr valign="top" id="yendif-player-row-youtube">
            ...
            <td>
            	<input type="text" name="youtube" id="youtube" class="required yendif-player-wide" value="<?php echo $item->youtube; ?>" />
          ...
          <tr valign="top" id="yendif-player-row-rtmp">
            ...
            <td>
            	<input type="text" name="rtmp" id="rtmp" class="required yendif-player-wide" value="<?php echo $item->rtmp; ?>" />
          ...
          <tr valign="top" id="yendif-player-row-flash">
            ...
            <td>
            	<input type="text" name="flash" id="flash" class="required yendif-player-wide" value="<?php echo $item->flash; ?>" />
              	<p class="yendif-player-description">
          ...
          <tr valign="top" id="yendif-player-row-fallback">
            ...
            <td>
				<?php echo Yendif_Player_Admin_Functions::uploader( 'fallback', YENDIF_PLAYER_PLUGIN_SLUG, 'video', $item->mp4 ); ?>
              	<p class="yendif-player-description">
          ...
          <tr valign="top" id="yendif-player-row-mp4">
            ...
            <td>
				<?php echo Yendif_Player_Admin_Functions::uploader( 'mp4', YENDIF_PLAYER_PLUGIN_SLUG, 'video', $item->mp4, 'required ' ); ?>
              	<p class="yendif-player-description">
                	<?php _e( "It's always recommended using <strong>Mp4</strong> as it gives a complete cross browser support with the aid of Flash. This makes your video playable anywhere.", YENDIF_PLAYER_PLUGIN_SLUG ); ?>
              	</p>
          	</td>
          ...
          <tr valign="top" id="yendif-player-row-webm">
            ...
            <td><?php echo Yendif_Player_Admin_Functions::uploader( 'webm', YENDIF_PLAYER_PLUGIN_SLUG, 'video', $item->webm ); ?></td>
          </tr>
          <tr valign="top" id="yendif-player-row-mp3">
            <th scope="row"><?php _e( 'MP3', YENDIF_PLAYER_PLUGIN_SLUG ); ?></th>
            <td><?php echo Yendif_Player_Admin_Functions::uploader( 'mp3', YENDIF_PLAYER_PLUGIN_SLUG, 'audio', $item->mp3, 'required ' ); ?></td>
          </tr>
          <tr valign="top" id="yendif-player-row-wav">
            <th scope="row"><?php _e( 'WAV&nbsp;(optional)', YENDIF_PLAYER_PLUGIN_SLUG ); ?></th>
            <td><?php echo Yendif_Player_Admin_Functions::uploader( 'wav', YENDIF_PLAYER_PLUGIN_SLUG, 'audio', $item->wav ); ?></td>
          </tr>
          <tr valign="top" id="yendif-player-row-ogg">
            <th scope="row"><?php _e( 'OGG&nbsp;(optional)', YENDIF_PLAYER_PLUGIN_SLUG ); ?></th>
            <td><?php echo Yendif_Player_Admin_Functions::uploader( 'ogg', YENDIF_PLAYER_PLUGIN_SLUG, 'ogg', $item->ogg ); ?></td>
          </tr>
          <tr valign="top">
            <th scope="row"><?php _e( 'Poster&nbsp;(optional)', YENDIF_PLAYER_PLUGIN_SLUG ); ?></th>
            <td><?php echo Yendif_Player_Admin_Functions::uploader( 'poster', YENDIF_PLAYER_PLUGIN_SLUG, 'image', $item->poster ); ?></td>
          </tr>
          <tr valign="top" id="yendif-player-row-vtt">
            <th scope="row"><?php _e( 'Subtitle&nbsp;(optional)', YENDIF_PLAYER_PLUGIN_SLUG ); ?></th>
            <td><?php echo Yendif_Player_Admin_Functions::uploader( 'captions', YENDIF_PLAYER_PLUGIN_SLUG, 'image', $item->captions ); ?></td>
          </tr>
          <tr valign="top">
            <th scope="row"><?php _e( 'Duration&nbsp;(optional)', YENDIF_PLAYER_PLUGIN_SLUG ); ?></th>
            <td>
            	<input type="text" name="duration" id="duration" class="yendif-player-small yendif-player-center" placeholder="00:00" value="<?php echo $item->duration; ?>" />
          ...
          <tr valign="top" id="yendif-player-row-views">
            ...
            <td>
            	<input type="text" name="views" id="views" class="yendif-player-small yendif-player-center" value="<?php echo $item->views; ?>" />
              	<span class="yendif-player-description">
    ...
    <div class="yendif-player-right-content">
        ...
        <div class="yendif-player-box-content">
        	<div class="yendif-player-box-inner">
            	<label class="yendif-player-featured yendif-player-block" for="yendif-player-featured">
            		<input type="checkbox" id="yendif-player-featured" name="featured" value="1" <?php if ( $item->featured == 1 ) echo 'checked'; ?>>
        		...
        		<label class="yendif-player-published yendif-player-block" for="yendif-player-published">
            		<input type="checkbox" id="yendif-player-published" name="published" value="1" <?php if ( $item->published == 1 ) echo 'checked'; ?>>
      ...
      <div class="yendif-player-box">
        ...
        <div class="yendif-player-box-content">
          <div class="yendif-player-box-inner"> <?php echo Yendif_Player_Admin_Functions::playlists( $item->playlists ); ?> </div>
        </div>
      </div>
    </div>
    <input type="hidden" name="post_id" id="post_id" value="<?php echo $item->post_id; ?>">
  </form>
</div>