...
require_once('latest-videos.php' );

class Yendif_Latest_Videos_Widget extends WP_Widget {	
	...
	public function __construct() {
		parent::__construct(
			'yendif-latest-videos',
			__('Yendif Latest Videos', YENDIF_PLAYER_PLUGIN_SLUG),
			array( 'description' => __('Use this widget to show Latest Yendif Videos in your website\'s sidebar.', YENDIF_PLAYER_PLUGIN_SLUG) )
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$videos = new Yendif_Latest_Videos();	
	...
	public function form( $instance ) {
		$defaults = array( 
			'title'             =>  __('Latest Videos', YENDIF_PLAYER_PLUGIN_SLUG),
			'thumb_width'       => 145,
			'thumb_height'      => 80,
			'limit'        	    => 5,
