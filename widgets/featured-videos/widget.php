...
require_once('featured-videos.php' );

class Yendif_Featured_Videos_Widget extends WP_Widget {	
	...
	public function __construct() {
		parent::__construct(
			'yendif-featured-videos',
			__('Yendif Featured Videos', YENDIF_PLAYER_PLUGIN_SLUG),
			array( 'description' => __('Use this widget to show Featured Yendif Videos in your website\'s sidebar.', YENDIF_PLAYER_PLUGIN_SLUG ) )
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$videos = new Yendif_Featured_Videos();	
	...
	public function form( $instance ) {
		$defaults = array( 
			'title'             => __('Featured Videos', YENDIF_PLAYER_PLUGIN_SLUG),
			'sort'              => 'latest',
			'thumb_width'       => 145,
			'thumb_height'      => 80,
			'limit'        	    => 5,
